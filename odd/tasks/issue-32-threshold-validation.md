...
Native review assessment for the PR slice (`--base-ref origin/main --committed-only`), then on the maintainer's go-ahead push and open the PR against `main` with `Closes #32`.
