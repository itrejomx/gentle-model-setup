...
Maintainer decisions: which slice 12 review findings become a follow-up slice or issue, and whether `.gga` is tracked. Then close-out TC.1, TC.3, TC.4 (docs fixes) and TC.2 (archive, needs explicit go-ahead). Merge order for the chain starts at #17.
