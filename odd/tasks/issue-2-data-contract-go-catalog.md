...
Slice 12 on branch `feat/2-cli-ci-error-surfaces`: T10.5 (RED) first, then T10.6-T10.9. Route: delegated direct, one writer (2+ non-trivial files: two CLIs, the workflow, `validate.ts` error surfaces, and their tests).
